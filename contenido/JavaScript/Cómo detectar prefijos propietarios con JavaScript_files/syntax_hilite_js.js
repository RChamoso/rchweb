...
function hidePlainTxt(bID) {
	...
	if(arrCode[bID]=="") {
		...
		var sInnerHTML = "<a href=\"#\" onclick=\"javascript:showPlainTxt('"+bID+"'); return false;\">TEXTO PLANO</a>";
...
function showPlainTxt(bID) {
	...
	sInnerHTML = "<a href=\"#\" onclick=\"javascript:hidePlainTxt('"+bID+"'); return false;\">CODIGO RESALTADO</a>";
	oLnk.innerHTML = sInnerHTML;
