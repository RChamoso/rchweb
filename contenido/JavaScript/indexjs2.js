...
var	MiscellaneousSymbolsArrows = {
...
var codigoAsciiN = [ basico, LatinE, LatinEA, LatinEB, LatinEC, LatinED, LatinS, LinearB, SuperscriptsSubscripts, CurrencySymbols, LetterlikeSymbols,
					NumberForms, EnclosedAlphanumeric, EnclosedAlphanumericS, Arrows, ArrowsA, ArrowsB, MiscellaneousSymbolsArrows, Simbolos,
					MiscellaneousS, MiscellaneousSA, Dingbats, GeneralP, BlockE, BoxDrawing, GeometricS, Cuneiform, MiscellaneousT, MathematicalO,
					MathematicalSA, SupplementalMathematicalO, MiscellaneousMSB, AlphabeticPresentationF, VariationSelectors, VerticalForms,
					SmallFormV, HalfwidthFullwidthF, Specials, Tags, VariationSelectorsS, ControlPictures, CombiningHalfM, Gothic, OldItalic,
					IdeographicD, ModifierToneLetters, OpticalCharacter, Diacritico, CombiningDiacriticalM, Diacritical, IPA, Braille, MusicalSymbols,
					ByzantineMusicalS, AncientGreekMN, AlchemicalSymbols, GameSymbols, MapSymbols, SupplementalPunctuation, EnclosedIdeographicS
];
var	BamumS = {
...
var codigoAsciiChino = [ BamumS, KangxiRadicals, Miao
];
var	Arabe = {
		titulo		: 'Arabe',
		tabla		: 'Arabe',
...
var codigoAsciiArabe = [ Arabe, ArabeS, ArabicExtendedA, ArabicMathematicalAS, ArabicPFA, ArabicPFB, OldSouthArabian, EgyptianHieroglyphs, Sirio, Thaana
];
var	AncientSymbols = {
...
var codigoAsciiAntiguo = [ AncientSymbols, Armenio, ArmenioS, ImperialAramaic, Carian, Coptic, CypriotSyllabary, Cyrilico, CyrilicoS, CyrillicExtendedA,
							CyrillicExtendedB, Deseret, Griego, GreekE, AncientGreekN, Hebreo, IndicNumbersF, Lycian, Osmanya, OldPersian, PhaistosDisc,
							Shavian, Ugaritic
];
var	AegeanNumbers = {
...
var codigoAsciiOtrosIdiomas = [ AegeanNumbers, Avestan, Balinese, Bamum, Batak, Bengali, Bopomofo, BopomofoE, Brahmi, Buginese, Buhid, Canada, CanadaA,
								Chakma, Cham, Cherokee, CountingRodNumerals, Devanagari, DevanagariE, Ethiopic, EthiopicA, EthiopicB, Georgian,
								GeorgianS, Glagolitic, Gurmukhi, Gujarati, Hangul, HangulS1, HangulS2, HangulCJamo, HangulSyllables, Hanunoo, Hiragana,
								Javanese, Kaithi, KanaS, Kanbun, Kannada, Katakana, KatakanaPhoneticE, KayahLi, Khmer, KhmerS, Kharoshthi, Lao, Lepcha,
								Lydian, Limbu, Lisu, Malayalam, MathematicalAlphanumericS, Mandaic, MeeteiMayek, MeeteiMayekE, Meroitic, Mongolian,
								Myanmar, MyanmarS, NKo, Ogham, OlChiki, Oriya, InscriptionalPahlavi, InscriptionalParthian, PhagsPa, Phonetic,
								Phoenician, Rejang, Runic, RumiNumeralS, Samaritano, Saurashtra, Sharada, Sinhala, SoraSompeng, Sundanese, SundaneseS,
								SylotiNagri, Tagalog, Tagbanwa, TaiLe, TaiLue, TaiTham, TaiViet, TaiXuanJingS, Takri, Tamil, Telugu, Thai, Tibetan,
								Tifinagh, OldTurkic, Vai, Vedic, YijingHexagramSymbols, YiRadicals, YiSyllables
];						
var	CJKCompatibility = {
...
var	CJKCompatibilityIdeographs = {
...
var codigoAsciiCJK = [ CJKCompatibility, CJKCompatibilityIdeographs, CJKCompatibilityIS, CJKCompatibilityF, CJKLettersMonthsE, CJKRadicalsS,
						CJKSymbolsP, CJKStrokes, CJKUnifiedIdeographs, CJKUnifiedIEA, CJKUnifiedIEB, CJKUnifiedIEC, CJKUnifiedIED
];
var	SClasificar1 = {
...
var codigoAsciiSC = [ SClasificar1, SClasificar2, SClasificar3, SClasificar4, SClasificar5, SClasificar6, SClasificar7, SClasificar8,
					SClasificar9, SClasificar10, SClasificar11, SClasificar12, SClasificar13, SClasificar14, SClasificar15, SClasificar16,
					SClasificar17, SClasificar18, SClasificar19, SClasificar20, SClasificar21, SClasificar22, SClasificar23, SClasificar24,
					SClasificar25, SClasificar26, SClasificar27, SClasificar28, SClasificar29, SClasificar30, SClasificar31, SClasificar32,
					SClasificar33, SClasificar34, SClasificar35, SClasificar36
];*/
var tipoFuente = [
...
function inicio() {
	...
	if(navegador == 'Microsoft Internet Explorer') {
		...
		if(compatibleIE == false)
			alert('Para poder visualizar correctamente esta p·gina debes activar' +
					' el "Modo del Documento" a IE9 pulsando la tecla "F12"' +
					' y a continuaciÛn la combinaciÛn de teclas "Alt+9".');
	}
}

function mostrarArticulos(articulo,menuActual) {
	var articuloDiv = document.getElementById("seccionArticulo");
	articuloDiv.setAttribute('style','display:block');
	var articuloH1 = document.getElementById("tituloArticulo");
	...
	if (anterior == 'hoja') {
		var bloqueHoja = document.getElementById("hoja");
		bloqueHoja.setAttribute('style','display:none');
	}
	var menuDiv = document.getElementById(menuActual);
...
function mostrarFuncion(texto,dato){
	mostrarBloques("hoja");
	var titulo = document.getElementById("titulo");
	var nuevaVentana = document.getElementById("nuevaVentana");
		nuevaVentana.href = dato;
	var contenidoObject = document.getElementById("contenidoObject");
...
function nuevaVentana(dato) {
	window.open(dato, "nuevo");
}

/*
function AsciiBasico(tabla,contenido,boton,inicio,fin) {
	var tablaAscii = document.getElementById(tabla);
		tablaAscii.setAttribute('style','display:block');
	var botonCerrar = document.getElementById(boton);
		botonCerrar.setAttribute('style','display:inline-block');
	var contenidoAscii = document.getElementById(contenido);
		if (contenidoAscii.childElementCount > 0) {
			while (contenidoAscii.firstChild) {
				contenidoAscii.removeChild(contenidoAscii.firstChild);
			}
		}
	var j = 0;
	for (i=inicio; i<=fin; i++){
		...
		if  (codigoTexto != " ") {
			if  (i <= 127 || i >= 160){
				...
				if (j == 1 || (j-1)%10 == 0) {
					var lineaLista1 = document.createElement('tr');
					var lineaLista2 = document.createElement('tr');
				}
					var codigoLista1 = document.createElement('td');
						codigoLista1.setAttribute('style','width:3%');
						codigoLista1.textContent = codigo;
						lineaLista1.appendChild(codigoLista1);
					var textoLista = document.createElement('td');
					...
					var codigoLista2 = document.createElement('td');
						codigoLista2.textContent = codigoHex;
					lineaLista2.appendChild(codigoLista2);
				if ((j-1)%10 == 0) {
					contenidoAscii.appendChild(lineaLista1);
					contenidoAscii.appendChild(lineaLista2);
				}
			}
		}
	}
//	mostrarBloques("codigosAsciiCompleto");
}


*/
function codigosAscii(codigoAscii, tituloAscii) {

//		borrar los children anteriores


	var listaAscii = document.getElementById('menuCodigosAscii');
	if (listaAscii.childElementCount > 0) {
		while (listaAscii.firstChild) {
			listaAscii.removeChild(listaAscii.firstChild);
		}
	}
	var tituloAsciiH = document.getElementById('tituloAscii');
		tituloAsciiH.textContent = tituloAscii;
	for (i in codigoAscii) {
		var divAscii = document.createElement('div');
			var menuAscii = document.createElement('li');
				var opcionMenu = document.createElement('h4');
				var funcion = 'AsciiBasicoContenido("'+codigoAscii[i].tabla+'", "'+codigoAscii[i].contenido+'","'+codigoAscii[i].boton+'",'+codigoAscii[i].inicio+','+codigoAscii[i].fin+');';
					opcionMenu.setAttribute('onclick',funcion);
					opcionMenu.textContent = codigoAscii[i].titulo;
				menuAscii.appendChild(opcionMenu);
				cerrarMenu = document.createElement('p');	//boton
					cerrarMenu.setAttribute('id',codigoAscii[i].boton);
					cerrarMenu.setAttribute('class','AsciiBotonCerrar');
					var funcionCerrar = 'cerrar("'+codigoAscii[i].tabla+'","'+codigoAscii[i].boton+'")';
			...
			var tablaAscii = document.createElement('table');	//tabla
				tablaAscii.setAttribute('id',codigoAscii[i].tabla);
				...
				var contenidoTablaAscii = document.createElement('tbody');//contenido
					contenidoTablaAscii.setAttribute('id',codigoAscii[i].contenido);
...
/*								<table id=tabla class='codigosAsciiCompleto' border=1 cellpadding="2px">
									<tbody id='contenido'>
									</tbody>
								</table>
		titulo		: 'Latin Sumplemento',
		tabla		: 'latinSumplemento',
		contenido 	: 'AsciiLatinSumplemento',
		boton 		: 'cerrarLsuplemento',
*/
function AsciiBasicoContenido(tabla, contenido, boton, inicio, fin) {
	var cerrarMenu = document.getElementById(boton);
		cerrarMenu.setAttribute('style','display:inline-block');
	var divAscii = document.getElementById(tabla);
		divAscii.setAttribute('style','display:block');
	var contenidoTablaAscii = document.getElementById(contenido);
...
function cerrar(tabla,boton) {
	var cerrarTabla = document.getElementById(tabla);
...
function fuentes() {
	var contenidoFuentes = document.getElementById('fuentesBD');
		for (i in tipoFuente){
			...
			mayusculasFuentes.textContent = 'ABCDEFGHIJKLMN—OPQRSTUVWXYZ - ¡…Õ”⁄';
			minusculasFuentes.setAttribute('style',estiloFuentes);
			minusculasFuentes.textContent = 'abcdefghijklmnÒopqrstuvwxyz - ·ÈÌÛ˙';
